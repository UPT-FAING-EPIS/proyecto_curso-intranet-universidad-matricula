...
-- Volcando datos para la tabla sistema_matricula.detalle_matricula: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `detalle_matricula` DISABLE KEYS */;
INSERT INTO `detalle_matricula` (`id_detalle`, `fkidmatricula`, `fkidcurso`) VALUES
	(1, 1, 1),
	(2, 1, 2);
...
) ENGINE=InnoDB AUTO_INCREMENT=2020066919 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla sistema_matricula.estudiantes: ~3 rows (aproximadamente)
...
INSERT INTO `estudiantes` (`id_estudiante`, `nombre`, `apellido`, `dni`, `fecha_nacimiento`, `direccion`, `telefono`, `email`, `contrasena`) VALUES
	(2020066916, 'Gustavo Alonso', 'Valle Bustamante', '12345678', '2002-09-27', NULL, NULL, 'email', 'gv123'),
	(2020066917, 'Marcelo Jose', 'Medina Lopez', '12345679', '2023-05-04', NULL, NULL, NULL, 'mm123'),
	(2020066918, 'Moises Alessandro', 'Corrales Solis', '12345680', '2023-05-04', NULL, NULL, NULL, 'mc123');
...
INSERT INTO `matriculas` (`id_matricula`, `id_estudiante`, `id_seccion`, `id_semestre`, `estatus`, `fecha_matricula`) VALUES
	(1, 2020066916, 1, 1, 'activo', '2023-05-04');
...
-- Volcando datos para la tabla sistema_matricula.secciones: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla sistema_matricula.semestres: ~0 rows (aproximadamente)
